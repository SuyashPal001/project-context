...
// refundLipsyncCharge/refundMuxBeatAudioCharge exactly — see
// refundVideoCharge's comments (in videoCredits.ts) for why the
// amount/expiry are always read back from the ledger rather than trusted
