...
// Mirrors refundNarrationCharge/refundVideoCharge/refundImageCharge exactly —
// see those files' comments for why the amount/expiry are always read back
// from the ledger rather than trusted from in-memory state, and why the
// refund inherits the shortest expiry among the grants the original debit
// drew from.
