...
1. Intake: get the full script text, a voice pick (ask which language the narration should be read in if the brief implies anything other than English — pass that language through to Director), an optional product photo, and a presenter look brief (appearance, setting, wardrobe) if no photo anchors it.
