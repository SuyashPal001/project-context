    ...
    return (
        <div className="flex items-center justify-between px-6 pt-6 pb-4 bg-background z-10 shrink-0">
            <div className="flex items-center gap-3">
                ...
                <PersonaAvatar persona={selectedConversation.agent?.persona} avatarUrl={selectedConversation.agent?.avatarUrl} size={36} className="rounded-full" icon={getAgentTypeIcon(selectedConversation.agent?.type)} />
                <div>
