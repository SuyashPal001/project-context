...
const DESCRIPTION =
  "project context gives your team a coordinated AI engineering team: Product Manager, Analyst, Project Manager, Tech Lead, and Architect — five specialists that plan, write, and execute alongside your engineers.";
...
const faqs = [
  {
    ...
    a: "An AI engineering team is a set of coordinated AI agents, each with a distinct role, that works alongside your human engineers to handle product planning, requirements writing, project management, and architecture decisions. project context provides five specialists: Product Manager, Analyst, Project Manager, Tech Lead, and Architect.",
  },
  {
    q: "How is project context different from a single AI assistant like ChatGPT or GitHub Copilot?",
    a: "project context is a multi-agent team, not a single assistant. Each specialist runs a deterministic workflow tailored to its role. Outputs are artifacts — PRDs, roadmaps, task boards — not chat transcripts. Agents are grounded in your actual knowledge base and codebase. Human approval gates control every phase transition. And outputs are scored for quality, so the team improves over time.",
  },
  {
    q: "Does the AI engineering team integrate with my existing tools?",
    a: "project context has MCP integrations with GitHub, Jira, Gmail, Google Workspace, and Zoho. The task board is built in. The codebase indexer connects to your repositories. Additional integrations can be added via the MCP server.",
  },
  {
    q: "Is project context suitable for small engineering teams?",
    a: "Yes. project context is designed for engineering teams of any size. A solo founder gets a full planning and architecture team. A 5-person team gets the bandwidth of a much larger org without the coordination overhead. Agents are available immediately, with no onboarding or ramp-up.",
  },
  {
    q: "Which AI models power project context?",
    a: "project context routes to the appropriate model for each task. Fast, lightweight models handle real-time chat and quick lookups. Extended-thinking models handle PRD writing, milestone sequencing, and complex architecture questions. The routing is automatic — you don't configure it.",
  },
  {
      ...
      <section className="mx-auto max-w-6xl px-6 pt-32 pb-20">
        <div className="max-w-3xl">
          ...
          <p className="mt-8 max-w-xl text-lg leading-relaxed text-[var(--mk-muted)]">
            project context gives your engineering team a built-in AI crew — a
