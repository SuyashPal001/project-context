...
export const metadata: Metadata = {
  title: "Terms of Service — project context",
  description: "Terms and conditions for using project context.",
    ...
    <div className="mx-auto max-w-3xl px-6 py-24">
      ...
      <div className="prose prose-invert prose-sm max-w-none space-y-8 text-[var(--mk-muted)] leading-relaxed">
        <section>
          ...
          <p>
            By accessing or using project context ("the Service"), you agree to be bound by these
        ...
        <section>
          ...
          <p>
            You may use project context for lawful purposes only. You are responsible for all
        ...
        <section>
          ...
          <p>
            To the maximum extent permitted by law, project context is provided "as is" without
