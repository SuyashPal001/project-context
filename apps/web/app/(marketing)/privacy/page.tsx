...
export const metadata: Metadata = {
  title: "Privacy Policy — project context",
  description: "How project context collects, uses, and protects your data.",
    ...
    <div className="mx-auto max-w-3xl px-6 py-24">
      ...
      <div className="prose prose-invert prose-sm max-w-none space-y-8 text-[var(--mk-muted)] leading-relaxed">
        ...
        <section>
          ...
          <p>
            Your data is used solely to provide and improve project context. We do not sell your
