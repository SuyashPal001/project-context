            ...
            <div className="relative z-10 w-full max-w-md p-8 space-y-6 rounded-xl border border-border bg-card shadow-card">
                    ...
                    <>
                        <Form {...emailForm}>
                            <form onSubmit={emailForm.handleSubmit(onEmailSubmit)} className="space-y-4">
                                ...
                                <Button type="submit" className="w-full bg-gradient-to-br from-[#E69DB8] to-[#F2A679] text-black hover:opacity-90 border-0" disabled={isLoading}>{isLoading ? 'Checking...' : 'Continue'}</Button>
                            </form>
                        </Form>
                        {process.env.NEXT_PUBLIC_COGNITO_DOMAIN && (
                            <>
                                ...
                                <Button type="button" className="w-full bg-gradient-to-br from-[#E69DB8] to-[#F2A679] text-black hover:opacity-90 border-0" onClick={() => initiateGoogleSignIn(redirectParam)} disabled={isLoading}>
                    ...
                    <>
                        <Form {...passwordForm}>
                            <form onSubmit={passwordForm.handleSubmit(onPasswordSubmit)} className="space-y-4">
                                ...
                                <Button type="submit" className="w-full bg-gradient-to-br from-[#E69DB8] to-[#F2A679] text-black hover:opacity-90 border-0" disabled={isLoading}>{isLoading ? 'Signing in...' : 'Sign in'}</Button>
                            </form>
                        </Form>
                ...
                {step === 'google' && (
                    <>
                        ...
                        <Button type="button" className="w-full bg-gradient-to-br from-[#E69DB8] to-[#F2A679] text-black hover:opacity-90 border-0" onClick={() => initiateGoogleSignIn(redirectParam)}>
                            <svg className="mr-2 h-4 w-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 488 512">
                                <path fill="#4285F4" d="M488 261.8C488 403.3 391.1 504 248 504 110.8 504 0 393.2 0 256S110.8 8 248 8c66.8 0 123 24.5 166.3 64.9l-67.5 64.9C258.5 52.6 94.3 116.6 94.3 256c0 86.5 69.1 156.6 153.7 156.6 98.2 0 135-70.4 140.8-106.9H248v-85.3h236.1c2.3 12.7 3.9 24.9 3.9 41.4z" />
                            </svg>
                            Continue with Google
