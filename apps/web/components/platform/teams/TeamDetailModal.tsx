                        ...
                        <div className="space-y-1.5">
                            {members.map((agent) => (
                                <div key={agent.id} className="flex items-center gap-2 rounded-md border border-border/50 px-2 py-1.5">
                                    <PersonaAvatar persona={agent.persona} avatarUrl={agent.avatarUrl} size={28} className="rounded-full" isDefault={agent.origin === "built_in"} />
                                ...
                                {available.length > 0 ? (
                                    available.map((agent) => (
                                        ...
                                        >
                                            ...
                                            />
                                            <PersonaAvatar persona={agent.persona} avatarUrl={agent.avatarUrl} size={24} className="rounded-full" isDefault={agent.origin === "built_in"} />
