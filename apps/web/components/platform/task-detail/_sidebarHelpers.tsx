...
export const STATUS_CONFIG = {
    ...
    awaiting_approval: { label: 'Awaiting Approval', color: '#6B7280', bg: 'bg-gray-500/10',    text: 'text-gray-400' },
    in_progress:       { label: 'In Progress',       color: '#F59E0B', bg: 'bg-amber-500/10',   text: 'text-amber-400' },
    review:            { label: 'Review',            color: '#6B7280', bg: 'bg-gray-500/10',    text: 'text-gray-400' },
