...
interface MessageThreadProps {
    ...
    onClarificationAnswer?: (messageId: string, clarificationId: string, questionIndex: number, answer: { selectedIndex?: number; selectedIndices?: number[]; freeText?: string; skipped?: boolean; files?: { fileId: string; name: string; type: string }[] }, allAnswered?: boolean) => void;
                        ...
                        try {
                            ...
                            if ((err as { status?: number }).status === 404) {
                                try {
                                    ...
                                    console.error('Failed to refresh URL for', att.fileId, fallbackErr);
